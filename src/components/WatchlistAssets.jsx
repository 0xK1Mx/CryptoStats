...
import styles from "./WatchlistAssets.module.css";
...
function WatchlistAssets({ watchList, handleOnAdd }) {
  const isWatched = true;

  const watchlistEl = watchList.map((el) => (
  ...
  return <AssetsContainer>{watchlistEl}</AssetsContainer>;
}
